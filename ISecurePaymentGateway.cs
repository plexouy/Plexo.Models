...
namespace Plexo
{
    ...
    public interface ISecurePaymentGateway
    {
        ...
        Task<ServerSignedResponse<ThreeDSSession>> ThreeDSValidate(ClientSignedRequest<ThreeDSValidation> threedsvalidation);
        ...
        Task<ServerSignedResponse<Session>> ExpressCheckoutSplit(ClientSignedRequest<ExpressCheckoutSplitRequest> expressCheckout);
        ...
        [OperationContract]
        [WebInvoke(UriTemplate = "Operation/Refundv2", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json, Method = "POST")]
        Task<ServerSignedResponse<Transaction>> Refundv2(ClientSignedRequest<RefundRequest> payment);
        ...
        [OperationContract]
        [WebInvoke(UriTemplate = "Instruments/ExternalAdd", RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json, Method = "POST")]
        Task<ServerSignedResponse<ExternalPaymentInstrument>> AddExternal(ClientSignedRequest<CreateExternalInstrumentRequest> request);
